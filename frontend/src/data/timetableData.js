...
export const timetableData = {
  Monday: {
    classes: [
      { id: 1, period: 1, time: '10:00-11:00', subject: 'Operating System', teacher: 'VM', room: '609', batch: 'A' },
      { id: 2, period: 1, time: '10:00-11:00', subject: 'Operating System', teacher: 'VM', room: '609', batch: 'B' },
      { id: 3, period: 2, time: '11:00-12:00', subject: 'Operating System', teacher: 'VM', room: '609', batch: 'A' },
      { id: 4, period: 2, time: '11:00-12:00', subject: 'Operating System', teacher: 'VM', room: '609', batch: 'B' },
  ...
  Friday: {
    classes: [
      ...
      { id: 53, period: 6, time: '15:00-16:00', subject: 'Microprocessor', teacher: 'VM', room: '620', batch: 'A' },
      { id: 54, period: 6, time: '15:00-16:00', subject: 'Operating System', teacher: 'VK', room: '623', batch: 'B' },
      { id: 55, period: 7, time: '16:00-17:00', subject: 'Microprocessor', teacher: 'VM', room: '620', batch: 'A' },
      { id: 56, period: 7, time: '16:00-17:00', subject: 'Operating System', teacher: 'VK', room: '623', batch: 'B' },
    ],
    labs: []
  },
  Saturday: {
    classes: [
      { id: 57, period: 1, time: '10:00-11:00', subject: 'IPS', teacher: 'SM', room: '604', batch: 'A' },
      { id: 58, period: 1, time: '10:00-11:00', subject: 'SCL', teacher: 'AB', room: '604', batch: 'B' },
      { id: 59, period: 2, time: '11:00-12:00', subject: 'IPS', teacher: 'SM', room: '604', batch: 'A' },
      { id: 60, period: 2, time: '11:00-12:00', subject: 'SCL', teacher: 'AB', room: '604', batch: 'B' },
      { id: 61, period: 4, time: '13:00-14:00', subject: 'IPS', teacher: 'SM', room: '609', batch: 'A' },
      { id: 62, period: 4, time: '13:00-14:00', subject: 'SCL', teacher: 'AB', room: '609', batch: 'B' },
      { id: 63, period: 5, time: '14:00-15:00', subject: 'IPS', teacher: 'SM', room: '609', batch: 'A' },
      { id: 64, period: 5, time: '14:00-15:00', subject: 'SCL', teacher: 'AB', room: '609', batch: 'B' },
      { id: 65, period: 6, time: '15:00-16:00', subject: 'IPS', teacher: 'SM', room: '604', batch: 'A' },
      { id: 66, period: 6, time: '15:00-16:00', subject: 'SCL', teacher: 'AB', room: '604', batch: 'B' },
      { id: 67, period: 7, time: '16:00-17:00', subject: 'IPS', teacher: 'SM', room: '604', batch: 'A' },
      { id: 68, period: 7, time: '16:00-17:00', subject: 'SCL', teacher: 'AB', room: '604', batch: 'B' },
